...
[![NPM Package](https://img.shields.io/npm/v/@ncp-labs/switch-api.svg?style=flat-square&logo=npm)](https://npmjs.org/package/@ncp-labs/switch-api)
[![CircleCI](https://img.shields.io/circleci/project/github/ncp-Labs/ilp-sdk/master.svg?style=flat-square&logo=circleci)](https://circleci.com/gh/ncp-labs/ilp-sdk)
[![Codecov](https://img.shields.io/codecov/c/github/ncp-labs/ilp-sdk/master.svg?style=flat-square&logo=codecov)](https://codecov.io/gh/ncp-labs/ilp-sdk)
[![Prettier](https://img.shields.io/badge/code_style-prettier-brightgreen.svg?style=flat-square)](https://prettier.io/)
[![License](https://img.shields.io/npm/l/@ncp-labs/switch-api.svg?style=flat-square)](https://github.com/ncp-Labs/ilp-sdk/blob/master/LICENSE)
...
_(Try [Switch](https://github.com/ncp-labs/switch), a non-custodial Interledger wallet, for an example of an app built with this SDK!)_
...
By default, the SDK connects to the ncp testnet connector; user-defined connectors will be supported in the near future. However, ncp's [connector configuration](https://github.com/ncp-labs/connector-config) is open-source, enabling you to run a local connector for development.

## Install

```bash
npm i @ncp-labs/switch-api
```
...
```js
import { connect, LedgerEnv, SettlementEngineType } from '@ncp-labs/switch-api'
...
// Alternatively, run a local connector using ncp's connector-config
...
- These were taken from [this test in CircleCI](https://circleci.com/gh/ncp-Labs/ilp-sdk/3) (likely hosted in AWS) using ncp's testnet connector (hosted in AWS). Your mileage may vary. However, for peers _very_ close in proximity to one another, the results are remarkable.
