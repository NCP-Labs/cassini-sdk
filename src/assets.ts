import { AssetUnit } from '@ncp-labs/crypto-rate-utils'
...
export const CONNECTOR_LIST: {
  ...
  /** Mainnet connectors */
  {
    operatorName: 'ncp Labs',
    ledgerEnv: LedgerEnv.Mainnet,
    assetType: 'BTC',
    settlerType: SettlementEngineType.Lnd,
    btp: token => `btp+wss://:${token}@ilp.ncp.io/btc`
  },
  {
    operatorName: 'ncp Labs',
    ledgerEnv: LedgerEnv.Mainnet,
    ...
    btp: token => `btp+wss://:${token}@ilp.ncp.io/eth`
  },
  {
    operatorName: 'ncp Labs',
    ledgerEnv: LedgerEnv.Mainnet,
    ...
    btp: token => `btp+wss://:${token}@ilp.ncp.io/xrp`
  },
  {
    operatorName: 'ncp Labs',
    ledgerEnv: LedgerEnv.Mainnet,
    assetType: 'DAI',
    settlerType: SettlementEngineType.Machinomy,
    btp: token => `btp+wss://:${token}@ilp.ncp.io/dai`
  },
  /** Testnet connectors */
  {
    operatorName: 'ncp Labs',
    ...
    assetType: 'BTC',
    settlerType: SettlementEngineType.Lnd,
    btp: token => `btp+wss://:${token}@test.ilp.ncp.io/btc`
  },
  {
    operatorName: 'ncp Labs',
    ledgerEnv: LedgerEnv.Testnet,
    assetType: 'ETH',
    settlerType: SettlementEngineType.Machinomy,
    btp: token => `btp+wss://:${token}@test.ilp.ncp.io/eth`
  },
  {
    operatorName: 'ncp Labs',
    ledgerEnv: LedgerEnv.Testnet,
    assetType: 'XRP',
    settlerType: SettlementEngineType.XrpPaychan,
    btp: token => `btp+wss://:${token}@test.ilp.ncp.io/xrp`
  },
  {
    operatorName: 'ncp Labs',
    ledgerEnv: LedgerEnv.Testnet,
    assetType: 'DAI',
    settlerType: SettlementEngineType.Machinomy,
    btp: token => `btp+wss://:${token}@test.ilp.ncp.io/dai`
  },
  /** Local connectors */
  {
    operatorName: 'ncp Labs',
